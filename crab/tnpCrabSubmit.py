...
#
submitVersion = "2021-09-24-20UL_1718FINAL" # add some date here
doL1matching  = False

defaultArgs   = ['doEleID=True','doPhoID=False','doTrigger=False']
mainOutputDir = '/store/user/asculac/TnPtuples/%s' % submitVersion
...
config.Site.storageSite                = 'T3_CH_CERNBOX'  #T2_CH_CERN  # ?
...
def getLumiMask(era):
  ...
  elif era=='UL2017': return '/home/llr/cms/skulac/TnP_test/CMSSW_10_6_20/src/EgammaAnalysis/TnPTreeProducer/crab/LumiMask/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt'
  elif era=='UL2016preVFP': return '/home/llr/cms/skulac/TnP_test/CMSSW_10_6_20/src/EgammaAnalysis/TnPTreeProducer/crab/LumiMask/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt' #Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt'
  elif era=='UL2016postVFP': return '/home/llr/cms/skulac/TnP_test/CMSSW_10_6_20/src/EgammaAnalysis/TnPTreeProducer/crab/LumiMask/Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt'
  elif era=='UL2018': return '/home/llr/cms/skulac/TnP_test/CMSSW_10_6_20/src/EgammaAnalysis/TnPTreeProducer/crab/LumiMask/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'
...
if isReleaseAbove(10,6):
  era       = 'UL2017'
  submitWrapper('Run2017B', '/SingleElectron/Run2017B-UL2017_MiniAODv2-v1/MINIAOD', era) # /SingleElectron/Run2017B-09Aug2019_UL2017-v1/MINIAOD
  submitWrapper('Run2017C', '/SingleElectron/Run2017C-UL2017_MiniAODv2-v1/MINIAOD', era) # /SingleElectron/Run2017C-09Aug2019_UL2017-v1/MINIAOD
  submitWrapper('Run2017D', '/SingleElectron/Run2017D-UL2017_MiniAODv2-v1/MINIAOD', era) #/SingleElectron/Run2017D-09Aug2019_UL2017-v1/MINIAOD
  submitWrapper('Run2017E', '/SingleElectron/Run2017E-UL2017_MiniAODv2-v1/MINIAOD', era) #/SingleElectron/Run2017E-09Aug2019_UL2017-v1/MINIAOD
  submitWrapper('Run2017F', '/SingleElectron/Run2017F-UL2017_MiniAODv2-v1/MINIAOD', era) #/SingleElectron/Run2017F-09Aug2019_UL2017_EcalRecovery-v1/MINIAOD

  submitWrapper('DY_NLO',  '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL17MiniAOD-106X_mc2017_realistic_v6-v1/MINIAODSIM', era)
  ...
  submitWrapper('DY_NLO',   '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM', era)
  #submitWrapper('DY_LO',    '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM', era)  #19UL
  submitWrapper('DY_LO',    '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM', era) #20UL

  era       ='UL2016preVFP'
  submitWrapper('Run2016Bv1', '/SingleElectron/Run2016B-21Feb2020_ver1_UL2016_HIPM-v1/MINIAOD', era) #
  submitWrapper('Run2016Bv2', '/SingleElectron/Run2016B-21Feb2020_ver2_UL2016_HIPM-v1/MINIAOD', era) #
