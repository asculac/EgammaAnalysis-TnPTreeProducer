...
if varOptions.era not in ['2016', '2017', '2018', 'UL2017', 'UL2018','UL2016preVFP','UL2016postVFP']: log.error('%s is not a valid era' % varOptions.era)
...
if varOptions.GT == "auto":
  if options['isMC']:
    ...
    if options['era'] == 'UL2016preVFP': options['GLOBALTAG'] = '106X_dataRun2_v28'#
    if options['era'] == 'UL2016postVFP': options['GLOBALTAG'] = '106X_dataRun2_v28'#
  else:
